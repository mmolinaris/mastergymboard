    ...
    <div style={{ padding: "20px 16px 100px", minHeight: "100vh", background: S.bg }}>
      ...
      <div style={{ background: S.white, borderRadius: 16, padding: 20, marginBottom: 12, border: `1px solid ${S.border}` }}>
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 14, flexWrap: "wrap" }}>
          {config.telefono && <a href={`tel:${config.telefono}`} style={{ flex: 1, minWidth: "45%", background: S.redLight, border: `1px solid ${S.redBorder}`, borderRadius: 10, padding: "11px 8px", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: S.red, fontWeight: 700, fontSize: 12 }}><Phone size={14} /> Chiama</a>}
          <a href="https://wa.me/393663991378" target="_blank" rel="noreferrer" style={{ flex: 1, minWidth: "45%", background: "#E8F5E9", border: "1px solid #A5D6A7", borderRadius: 10, padding: "11px 8px", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#2E7D32", fontWeight: 700, fontSize: 12 }}>💬 WhatsApp</a>
          <a href="https://www.instagram.com/asd_palestra_mastergym/" target="_blank" rel="noreferrer" style={{ flex: 1, minWidth: "45%", background: S.grayLight, border: `1px solid ${S.border}`, borderRadius: 10, padding: "11px 8px", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: S.grayDark, fontWeight: 700, fontSize: 12 }}><Instagram size={14} /> Instagram</a>
          <a href="https://www.facebook.com/palestraasdmastergym/" target="_blank" rel="noreferrer" style={{ flex: 1, minWidth: "45%", background: "#E8F0FE", border: "1px solid #C5D2F6", borderRadius: 10, padding: "11px 8px", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, color: "#1565C0", fontWeight: 700, fontSize: 12 }}><Facebook size={14} /> Facebook</a>
        </div>
      </div>
      {/* Corsi */}
      {corsi.length > 0 && (
